...
function AboutUs() {
    return (
      <div className=' text-pretty content-center'>
          <div className= 'bg-pages grid justify-items-center px-3 py-6 -z-10 w-full lg:grid-cols-2 lg:grid-rows-2'>
              ...
              <div className='animate__animated animate__fadeIn bg-black m-4 w-4/5 lg:pb-16 content-center'>
