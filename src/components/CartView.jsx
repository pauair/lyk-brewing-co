...
function CartView() {
    ...
    return (
        <div className='flex flex-col py-8 px-8 text-center justify-items-center content-center bg-pages min-h-screen'>
            {<h2 className='text-white font-bold text-2xl p-6 text-center lg:text-3xl'> MY CART </h2>}
            {isCartEmpty && <p className='text-white text-center py-16 font-bold justify-self-center h-screen lg:text-lg'> Your cart is empty. <br/> Add products to see them here.</p>}
            ...
            <div className='bg-pages pt-9'>
                {!isCartEmpty && <p className=' bg-pages text-white text-sm font-semibold border-double border border-green-900 rounded-md my-6 mx-8 p-3 lg:p-2 lg:mx-96 lg:text-lg'>TOTAL: {totalPrice()} UYU</p>}
